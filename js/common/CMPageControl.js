...
var CMPageControl = React.createClass({
  propTypes: {
...
module.exports = CMPageControl;
module.exports.__cards__ = (define) => {
  define('Simple 2', () => <CMPageControl count={2} selectedIndex={0} />);
  define('Simple 5', () => <CMPageControl count={5} selectedIndex={2} />);
};
